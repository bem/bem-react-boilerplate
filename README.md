...
We use [bem-react-core](https://bem.gitbooks.io/bem-react-core/en/REFERENCE.html) for component declaration. Feel free to read documentation ;)
...
Also, we use [bem-import notation](https://github.com/bem/bem-sdk/tree/master/packages/import-notation) for importing components which are BEM entites.
...
This project setup uses [Webpack](https://webpack.js.org/) for handling all assets. Webpack offers a custom way of “extending” the concept of `import` beyond JavaScript. Since we use bem-import notation we don't need to implicitly import CSS files. But you steel can import separated CSS files as well.

### `src/blocks/Button/Button.css`
...
import Button from 'b:Button'; // here we import CSS and JS
import 'b:Button'; // here we import CSS only

import './style.css'; // not recommended
...
import logoSvg from '../Logo/App-Logo.svg'; // Tell Webpack this JS file uses this image

console.log(logoSvg); // /logo.84287d09.png
